                    ...
                    <div class="card-body">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label>Status:</label>
                                    <select class='form-control' v-model='question.status' name="status">
                            ...
                            <div class="col-md-4 form-group" text-align="center" style="color: green;" v-if="success">
                                question updated successfully.</div>
...
export default {
    ...
    methods: {
        ...
        //show details of particular question which needs to be edit
        async showquestion() {
            await axios.get(`/api/questions/${this.$route.params.id}`).then(response => {
                const { title, category_id, answer, status } = response.data
        ...
        async update() {
            ...
            await axios.put(`/api/questions/${this.$route.params.id}`, this.question).then(response => {
